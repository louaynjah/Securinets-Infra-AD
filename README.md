...
2. **Téléchargement des règles (Onglet Download) :**
   * Sélection et activation des listes de règles gratuites **ET telemetry** et **ET open**.
   ...
   ![Téléchargement des règles IDS](suricata-dl.png)
...
3. **Mise en place de la politique de blocage (Onglet Rules) :**
   ...
   * Modification de leur comportement pour forcer l'action **"Drop"** (Bloquer).
   ...
   ![Modification des règles en Drop](suricata-drop.png)
...
![Configuration des règles de pare-feu LAN](firewall-lan.png)
...
![Mise à jour du schéma AD pour LAPS](laps-schema.png)

Les permissions ont ensuite été accordées aux administrateurs du domaine et aux ordinateurs :

![Délégation des permissions LAPS](laps-permissions.png)
...
![Configuration GPO Blocage USB](gpo-usb.png)
...
![Preuve de blocage DNS externe](test-dns.png)
...
![Interception de la menace EICAR](test-eicar.png)
